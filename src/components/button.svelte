<script lang="ts" context="module">
	...
	export const buttonVariants = cva({
		base: [
			'relative inline-flex items-center justify-center rounded bg-white px-6 py-3 text-lg font-medium text-black ring-2 ring-inset ring-black transition-all duration-150 ease-in-out shadow-3px',
...
<button type="button" class={buttonVariants({ variant, className })} on:click {...$$restProps}>
	<slot />
</button>
